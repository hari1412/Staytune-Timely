...
public class PreferenceUtil {
    ...
    public static void setOneTimeAlarm(@NonNull Context context, @NonNull Class<?> cls, int hour, int min, int second, int id) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context.getApplicationContext(), id, intent, PendingIntent.FLAG_IMMUTABLE);
    ...
    public static boolean isPreselectionList(Context context) {
        return getBooleanSettings(context, "is_preselection", false);
    }
