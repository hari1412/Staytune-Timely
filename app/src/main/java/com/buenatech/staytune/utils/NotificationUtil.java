...
import com.buenatech.staytune.receivers.NotificationDismissButtonReceiver;import com.buenatech.staytune.utils.PreferenceUtil;import com.buenatech.staytune.utils.WeekUtils;
...
public class NotificationUtil {
    ...
    private static void sendNotification(@NonNull Context context, boolean alert, @Nullable NotificationCompat.Builder notificationBuilder, int id) {
        ...
        if (PreferenceUtil.isAlwaysNotification(context)) {
            ...
            PendingIntent btPendingIntent = PendingIntent.getBroadcast(context, UUID.randomUUID().hashCode(), buttonIntent, PendingIntent.FLAG_IMMUTABLE);
